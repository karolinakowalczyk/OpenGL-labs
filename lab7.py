...
def compile_shaders():
    vertex_shader_source =  """
        ...
        void main(void) {
            ...
            gl_Position = P_matrix * V_matrix * M_matrix * (position + vec4(gl_InstanceID / 10, gl_InstanceID % 10, 0, 0) + vec4(rand(vec2(gl_VertexID, gl_InstanceID)), rand(vec2(gl_VertexID, gl_InstanceID)), 0, 0));
